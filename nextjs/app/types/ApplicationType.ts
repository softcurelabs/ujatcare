...
export interface ApplicationType extends TimeStampType {
  ...
  rh_end_date_first: string;
  rh_end_date_second: string;
  rh_end_date_third: string;
  rh_start_date_first: string;
  rh_start_date_second: string;
  rh_start_date_third: string;
