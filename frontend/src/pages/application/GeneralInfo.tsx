    ...
    <>
      ...
      >
        ...
        <Modal.Body className="p-4 fs-4">
          <div className="">
            NPMS provides subsidized housing – rent is based on income.
          </div>
          <div>
            {" "}
          ...
          <div className="fw-bold">
            Fisgard House – 6 storey building – 844 Fisgard Street
          </div>
          <div className="mb-2">
            <ul>
          ...
          <div className="mb-2">
            <ul>
              ...
              <li>
                No Pets (Service Animals may be approved with proper
                certification and NPMS Boards Approval)
              </li>
            </ul>
            ...
            <div className="mb-2">
              <ul>
                ...
                <li>
                  Documents that indicate any payments currently received from
                  E.I. or W.C.B.
                </li>
                <li>
                  Seniors (65 plus) are required to provide a Rate Benefit
                  letter which is provided by Service Canada (1-800-277-9914).
                </li>
                <li>
                  Information on assets worth over $10,000 (cash, investments,
                  real estate).
                </li>
                <li>
                  Applicants that are not Canadian Citizens Require Confirmation
                  of their Status.
                </li>
              </ul>
            </div>
            ...
            <div>
              <ul>
                <li>
                  There is a minimum of at least 3 months for our waiting list.
                </li>
                <li>
                  (For correct information regarding our waitlist and vacancies,
                  please contact us directly to avoid misinformation)
                </li>
                <li>
                  Exceptions on our waitlist may occur based on need and
                  availability of suites.
                </li>
                <li>
                  Applicants are not contacted until they reach the short list.
                </li>
                <li>Credit checks may be done on applicants.</li>
                <li>
                  We recommend that you keep your application current by
                  contacting us after 3 months and providing any updated
                  information and current bank statements to help fast track the
                  process once we have an available suite.
                </li>
                <li>
                  Make sure that you have included all required documents.
                </li>
              </ul>
            </div>
          </div>
